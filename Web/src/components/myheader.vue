        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <i class="fa fa-envelope-o"> 待办事务</i>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img :src="uploadpath+'inst/'+memberinfo.instinfo.logo" class="user-image" alt="">
              <span class="hidden-xs">{{memberinfo.name}}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img :src="uploadpath+'inst/'+memberinfo.instinfo.logo" class="img-circle" alt="">
                <p>
                  {{memberinfo.name}} - {{memberinfo.position}}
                  <small>{{memberinfo.instinfo.name}}</small>
                </p>
              </li>
              <!-- Menu Footer-->
