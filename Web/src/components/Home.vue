<template>
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>A</b>ze</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Aze</b>环保监控</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
            <li><a href="index.html"><i class="fa fa-circle-o"></i> <span>总览</span></a></li>
            <li><a href="map.html"><i class="fa fa-map"></i> <span>地图</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        body
    <button-counter name="My journey with Vue"></button-counter>
    </section>
	<!-- /.content -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2018 <a href="#">安志环保监控</a>.</strong> All rights
    reserved.
  </footer>
